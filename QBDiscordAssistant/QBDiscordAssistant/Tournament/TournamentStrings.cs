namespace QBDiscordAssistant.Tournament
{
    public static class TournamentStrings
    {
        ...
        {
            return $"Add a list of comma-separated team names. If the team name has a comma, use another comma to escape it (like ,,). You can add a maximum of {teamsCount} teams.";
        }
